...
def main():
    ...
    filtered_src_embeddings, src_count = match_embeddings(src_vocab, embeddings)
    filtered_tgt_embeddings, tgt_count = match_embeddings(tgt_vocab, embeddings)

    print("\nMatching: ")
    match_percent  = [ _['match']/(_['match']+_['miss'])*100 for _ in [src_count, tgt_count]]
